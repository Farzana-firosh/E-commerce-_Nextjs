  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-[-14] pointer-events-none"
        style={{
          background: "radial-gradient(ellipse at 60% 40%, #ffb34733 0%, transparent 70%), radial-gradient(ellipse at 30% 70%, #1a298033 0%, transparent 70%)"
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-xl shadow-2xl p-8 rounded-2xl border border-white/20">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          >
            ...
            <span className="text-[#1a2980] font-medium hover:underline">Home</span>
          </div>
          <div className="flex items-center gap-2">
            <ShoppingBag className="w-7 h-7 text-[#ffb347]" />
            <span className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-r from-[#1a2980] to-[#ffb347]">ShopEase</span>
          </div>
        </div>
        {/* Heading */}
        ...
        <p className="text-center text-sm text-[#1a2980] mb-8 drop-shadow">
          {signUp ? 'Join ShopEase and start your shopping journey.' : 'Login to continue shopping the best deals.'}
        </p>
        {/* Form */}
        <form className="space-y-6">
          {signUp && (
            <div>
              <label className="block mb-1 text-sm font-medium text-[#f2e9e1] drop-shadow">Name</label>
              <input
                type="text"
          ...
          <div>
            <label className="block mb-1 text-sm font-medium text-[#f2e9e1] drop-shadow">Email</label>
            <input
              type="email"
              className="w-full rounded-xl px-4 py-3 bg-white/20 border border-[#e5e7eb]/40 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#ffb347] focus:border-[#ffb347] transition placeholder:text-[#bbb] text-[#222]"
          ...
          <div>
            <label className="block mb-1 text-sm font-medium text-[#f2e9e1] drop-shadow">Password</label>
            <input
              type="password"
              className="w-full rounded-xl px-4 py-3 bg-white/20 border border-[#e5e7eb]/40 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#ffb347] focus:border-[#ffb347] transition placeholder:text-[#bbb] text-[#222]"
              placeholder="********"
        ...
        <div className="flex items-center my-6">
          ...
          <span className="mx-3 text-[#f2e9e1] text-xs font-semibold drop-shadow">or</span>
          <div className="flex-grow h-px bg-[#f2e9e1]/40"></div>
        </div>
